...
define("TOOL_REDIR", (preg_match("/00000000000000000000000[a-f,0-9]{1}/", TOOL_PARAMS_ISS) ? (TOOL_HOST . "/launch.php". "?iss=" . TOOL_PARAMS_ISS . "&target_link_uri=" . TOOL_PARAMS_TARGET ) : (preg_match("/https:\/\/agora\.uned\.es/", TOOL_PARAMS_ISS) ? (TOOL_HOST . "/lms/publish.php") : (preg_match("/\/publicacion\/[a-f,0-9]{24}/", TOOL_PARAMS_TARGET) ? (TOOL_HOST . "/lms/publish_desarrollo.php") : (TOOL_PARAMS_TARGET)))) );
