...
define("TOOL_REDIR", (preg_match("/00000000000000000000000[a,c-f,0-9]{1}/", TOOL_PARAMS_ISS) ? (TOOL_HOST . "/lms/giccu/diffusion.php". "?iss=" . TOOL_PARAMS_ISS . "&target_link_uri=" . TOOL_PARAMS_TARGET ) : (preg_match("/https:\/\/agora\.uned\.es/", TOOL_PARAMS_ISS) ? TOOL_PARAMS_TARGET : (preg_match("/\/publicacion\/[a-f,0-9]{24}/", TOOL_PARAMS_TARGET) ? (TOOL_HOST . "/lms/giccu/diffusion.php") : (TOOL_PARAMS_TARGET)))) );
