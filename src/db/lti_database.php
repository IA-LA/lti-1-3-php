...
echo $url . ' ###### ' . TOOL_ISS . ' ###### ' . TOOL_REDIR . ' ###### ' . strpos($json_obj['data']['launch_parameters']['target_link_uri'], TOOL_REDIR) === false . ' READ ' . $json_obj['data']['launch_parameters']['target_link_uri'][0];
