...
if(strpos(get_headers("http://10.201.54.31:49151/servicios/json/RUTAS.json", 0, $opts)[0], 'OK')){
...
elseif (strpos(get_headers("http://127.0.0.1:49151/servicios/json/RUTAS.json", 0, $opts)[0], 'OK')) {
