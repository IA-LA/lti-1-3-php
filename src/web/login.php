...
LTI\LTI_OIDC_Login::new(new Lti_Database(["iss" => TOOL_ISS, "login_hint" => $_REQUEST['login_hint'], "target_link_uri" => TOOL_REDIR, "lti_message_hint" => $_REQUEST['lti_message_hint']]))
