...
LTI\LTI_OIDC_Login::new(new Lti_Database(["aiss" => $_REQUEST['iss'], "login_hint" => $_REQUEST['login_hint'], "atarget_link_uri" => $_REQUEST['target_link_uri'], "lti_message_hint" => $_REQUEST['lti_message_hint']]))
