...
try {
    ...
    echo '<embed id="embedE" src="' . ($post_param["https://purl.imsglobal.org/spec/lti/claim/target_link_uri"]). '/' . $_REQUEST['path'] . '?id_token='. $_REQUEST['id_token'] .'&state=' . $_REQUEST['state'] .'"
        style="
        position: fixed;
        top: 0;
        bottom: 0;
