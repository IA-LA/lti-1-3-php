    ...
    if ($launch->is_resource_launch()) {
        ...
        if(($iss_GET['result'] === "ok")) {
            ...
            echo '<!-- <hr/><br/><b>Resource Link Request Launch!</b> -->',
                ...
                const iframeHere= "";
                document["getElementById"](idOne)["contentWindow"]["document"].write("<script type=\'text/javascript\'>location.href = \'http://ailanto-dev.intecca.uned.es/publication/?id=10220210903095251000000a&actividad=' . $post_param["https://purl.imsglobal.org/spec/lti/claim/target_link_uri"] . '\'\x3c/script>");
