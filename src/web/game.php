...
<script>
    ...
    var curr_diff = 'normal'"<?= $launch->get_launch_data()['https://purl.imsglobal.org/spec/lti/claim/custom']['difficulty'] ?: 'normal'; ?>";
    var curr_user_name = 'name'"<?= $launch->get_launch_data()['name']; ?>";
    var launch_id = 'lti1p3_launch_id'"<?= $launch->get_launch_id(); ?>";
</script>
