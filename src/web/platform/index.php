...
<ul>
    ...
    <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=http://localhost:9001&login_hint=12345&target_link_uri=<?php echo TOOL_HOST; ?>%2Fgame.php&lti_message_hint=12345'">Games 101</li>
