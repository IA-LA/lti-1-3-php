...
<ul>
    ...
    <li>Users</li>
    <li>Courses</li>
    <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=5fc3860a81740b0ef098a970&login_hint=123456&target_link_uri=http://10.201.54.31:9001/Plantilla Azul_5e0df19c0c2e74489066b43f/index_default.html&lti_message_hint=123456'">Prueba 100</li>
