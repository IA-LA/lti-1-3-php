...
<ul>
    ...
    <li>Users</li>
    <li>Courses</li>
    <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=http%3A%2F%2Flocalhost:9001&login_hint=123456&target_link_uri=<?php echo TOOL_HOST; ?>%2FPlantilla Azul_5e0df19c0c2e74489066b43f%2Findex_default.html&lti_message_hint=123456'">Prueba 100</li>
    ...
    <!-- <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=game&login_hint=123456&target_link_uri=<?php echo TOOL_HOST; ?>/game.php&lti_message_hint=123456'">Games 101</li> -->
    <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=http://localhost:9001&login_hint=12345&target_link_uri=<?php echo TOOL_HOST; ?>/game.php&lti_message_hint=12345'">Game 101</li>
