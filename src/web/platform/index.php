...
<ul>
    ...
    <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=5fc3860a81740b0ef098a968&login_hint=123456&target_link_uri=<?php echo TOOL_HOST; ?>%2Fgame.php&lti_message_hint=123456'">Game BD</li>
    <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=5fc3860a81740b0ef098a983&login_hint=123456&target_link_uri=<?php echo TOOL_HOST; ?>%2FPlantilla Azul_5e0df19c0c2e74489066b43g/index_default.html&lti_message_hint=123456'">eContent BD</li>
