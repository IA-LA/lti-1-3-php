...
<ul>
    ...
    <li>Users</li>
    <li>Courses</li>
    <li class="sub" onclick="document.getElementById('frame').src='http://10.201.54.31:9001/login_econtent.php?iss=http%3A%2F%2Flocalhost:9001&login_hint=123456&target_link_uri=http://10.201.54.31:9001/Plantilla Azul_5e0df19c0c2e74489066b43f/index_default.html&lti_message_hint=123456'">Prueba 100</li>
    ...
    <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=5fc3860a81740b0ef098a971&login_hint=123456&target_link_uri=<?php echo TOOL_HOST; ?>%2Fgame.php&lti_message_hint=123456'">BBDD PHP 101</li>
    <li class="sub" onclick="document.getElementById('frame').src='<?php echo TOOL_HOST; ?>/login.php?iss=5fc3860a81740b0ef098a972&login_hint=123456&target_link_uri=<?php echo TOOL_HOST; ?>/Plantilla Azul_5e0df19c0c2e74489066b43f/index.php&lti_message_hint=123456'">BBDD PHP 102</li>
    <!--
